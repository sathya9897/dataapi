...
const ytgen = {
  ...
  "united states": {
    ...
    keywords: [
      { text: "professionals", value: 15 },
      { text: "reviewing", value: 10 },
      { text: "screen", value: 18 },
      { text: "screening", value: 42 },
      { text: "useful", value: 4 },
      { text: "videos", value: 24 },
      { text: "wireless", value: 19 },
      { text: "battery", value: 42 },
      { text: "display", value: 36 },
      { text: "good", value: 30 },
      { text: "phone", value: 28 },
      { text: "plus", value: 13 },
      { text: "price", value: 15 }
  ...
  india: {
    ...
    keywords: [
      { text: "screen", value: 14 },
      { text: "screening", value: 38 },
      { text: "useful", value: 23 },
      { text: "videos", value: 34 },
      { text: "wireless", value: 29 }
    ]
  },
  britain: {
    likes: [
    ...
    keywords: [
      ...
      { text: "plus", value: 13 },
      { text: "price", value: 15 },
      { text: "professionals", value: 65 },
      { text: "useful", value: 47 },
      { text: "videos", value: 22 },
      { text: "wireless", value: 12 }
    ]
  }
};
...
const twsearch = {
  ...
  keywords: [
    { text: "#samsung", value: 45 },
    { text: "#reviewing", value: 30 },
    { text: "screen", value: 18 },
    { text: "display", value: 82 },
    { text: "battery", value: 34 },
    { text: "#note7", value: 19 },
    { text: "wireless", value: 31 }
  ],
  stats: {
    likes: 0,
    retweets: 125,
...
const trending = {
  ...
  india: {
    ...
    lucknow: ["#lucknow1", "#lucknow2", "#lucknow3", "#lucknow4", "#lucknow5"],
    mumbai: ["#mumbai1", "#mumbai2", "#mumbai3", "#mumbai4", "#mumbai5"]
  },
  us: {
    newyork: ["#newyork1", "#newyork2", "#newyork3", "#newyork4", "#newyork5"],
    houstan: ["#houstan1", "#houstan2", "#houstan3", "#houstan4", "#houstan5"],
    chicago: ["#chicago1", "#chicago2", "#chicago3", "#chicago4", "#chicago5"]
  },
  uk: {
    ...
    bristol: ["#bristol1", "#bristol2", "#bristol3", "#bristol4", "#bristol5"],
    edinburgh: [
      "#edinburgh1",
      "#edinburgh2",
      "#edinburgh3",
...
module.exports = { ytgen, ytuser, twgen, twuser, twsearch, leads, trending };
